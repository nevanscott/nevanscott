...
permalink: /work/pom/
published: true
short: I helped develop a design system to accomodate frequent updates.
...
external: http://www.pomwonderful.com/
image: pom/home.png
slides:
  - image: pom/home.png
  ...
  - image: pom/recipes-crop.png
    description: Early on in the first round of the project, I took some time to build this custom rotation image area using "jQuery":http://jquery.com/, to showcase the photography of their recipes. Not much to look at, but this was a big step up from relying on Flash, and I had only been working with jQuery for a few weeks at the time.
---
