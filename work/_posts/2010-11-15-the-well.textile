...
slides:
  ...
  - image: well/middle-645.png
    description: For each of the sections, we wanted a quick way for visitors to browse through to find something of interest on the homepage, so I built these "infinite" sliders, which send new requests to Expression Engine to continue to pull content as you click on the arrows.
  - image: well/sections-645.png
    description: Each section is meant to feel like its own home, so the image in the header changes out to match.
---