...
When I was in school, my computer science professor was fond of saying, "Bits is bits." What he meant is that all of computer science is an abstraction.[1]
...
fn2. footnote here? TK

fn3. I should be very clear here in pointing out that I am certain these things are all possible and probably even easy to do on a Windows machine as well, but I don't know because I don't develop on a Windows machine. I can vouch for how easy these things are to do on a Mac.
